        ...
        if buildings_path.exists():
            ...
            if ambiguous:
                ...
                def _classify_building(feat: dict[str, Any]) -> None:
                    ...
                    props["xplane_material"] = result.get("wall_material", "mixed")
                    props["xplane_wall_color"] = result.get("wall_color", "beige")
                    props["xplane_window_density"] = result.get("window_density", "moderate")
